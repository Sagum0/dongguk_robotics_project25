...
bool robotics_interfaces__msg__trajectory_points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotics_interfaces.msg._trajectory_points.TrajectoryPoints", full_classname_dest, 59) == 0);
  }
  robotics_interfaces__msg__TrajectoryPoints * ros_message = _ros_message;
  {  // points
...
{
  /* NOTE(esteve): Call constructor of TrajectoryPoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotics_interfaces.msg._trajectory_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryPoints");
