...
{
  new (message_memory) robotics_interfaces::msg::TrajectoryPoints(_init);
}

void TrajectoryPoints_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robotics_interfaces::msg::TrajectoryPoints *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryPoints_message_member_array[1] = {
  {
    "points",  // name
    ...
    offsetof(robotics_interfaces::msg::TrajectoryPoints, points),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryPoints_message_members = {
  "robotics_interfaces::msg",  // message namespace
  "TrajectoryPoints",  // message name
  1,  // number of fields
  sizeof(robotics_interfaces::msg::TrajectoryPoints),
...
{
  return &::robotics_interfaces::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotics_interfaces, msg, TrajectoryPoints)() {
  return &::robotics_interfaces::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoints_message_type_support_handle;
}
